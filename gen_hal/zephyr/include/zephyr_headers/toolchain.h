...
#include <zephyr_headers/toolchain/xcc.h>
#elif defined(__CCAC__)
#include <zephyr_headers/toolchain/mwdt.h>
#elif defined(__ARMCOMPILER_VERSION)
#include <zephyr_headers/toolchain/armclang.h>
#elif defined(__llvm__) || (defined(_LINKER) && defined(__LLD_LINKER_CMD__))
#include <zephyr_headers/toolchain/llvm.h>
#elif defined(__GNUC__) || (defined(_LINKER) && defined(__GCC_LINKER_CMD__))
#include <zephyr_headers/toolchain/gcc.h>
#elif defined(__ICCARM__)
#include <zephyr_headers/toolchain/iar.h>
#else
