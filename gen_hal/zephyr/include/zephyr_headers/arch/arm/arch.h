...
//#include <zephyr_headers/devicetree.h>

#include <zephyr_headers/arch/arm/thread.h>
#include <zephyr_headers/arch/arm/exception.h>
#include <zephyr_headers/arch/arm/irq.h>
#include <zephyr_headers/arch/arm/error.h>
#include <zephyr_headers/arch/arm/misc.h>
#include <zephyr_headers/arch/common/addr_types.h>
#include <zephyr_headers/arch/common/ffs.h>
#include <zephyr_headers/arch/arm/nmi.h>
#include <zephyr_headers/arch/arm/asm_inline.h>
#include <zephyr_headers/arch/common/sys_bitops.h>
#if defined(CONFIG_GDBSTUB)
#include <zephyr_headers/arch/arm/gdbstub.h>
#endif

#ifdef CONFIG_CPU_CORTEX_M
#include <zephyr_headers/arch/arm/cortex_m/cpu.h>
#include <zephyr_headers/arch/arm/cortex_m/memory_map.h>
#include <zephyr_headers/arch/common/sys_io.h>
#elif defined(CONFIG_CPU_AARCH32_CORTEX_R) || defined(CONFIG_CPU_AARCH32_CORTEX_A)
#include <zephyr_headers/arch/arm/cortex_a_r/cpu.h>
#include <zephyr_headers/arch/arm/cortex_a_r/sys_io.h>
#if defined(CONFIG_AARCH32_ARMV8_R)
#include <zephyr_headers/arch/arm/cortex_a_r/lib_helpers.h>
#include <zephyr_headers/arch/arm/cortex_a_r/armv8_timer.h>
#else
#include <zephyr_headers/arch/arm/cortex_a_r/timer.h>
#endif
#endif
...
#include <zephyr_headers/fatal_types.h>
...
#include <zephyr_headers/arch/arm/mpu/arm_mpu.h>
#endif /* CONFIG_CPU_HAS_ARM_MPU */
#ifdef CONFIG_CPU_HAS_NXP_MPU
#include <zephyr_headers/arch/arm/mpu/nxp_mpu.h>
#endif /* CONFIG_CPU_HAS_NXP_MPU */
#endif /* CONFIG_ARM_MPU */
#ifdef CONFIG_ARM_AARCH32_MMU
#include <zephyr_headers/arch/arm/mmu/arm_mmu.h>
