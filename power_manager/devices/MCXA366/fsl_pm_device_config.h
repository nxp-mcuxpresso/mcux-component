...
#define PM_CONSTRAINT_COUNT                  (12U)
...
/*!
 * inputType: 4 bit width. Used to distinguish wuu input source type.
 *            00b: External pin input.
 *            01b: Internal peripheral interrupt.
 *            10b: Internal peripheral dma request or triggers.
 *
 * inputId:   4 bit width. Used to distinguish WUU input source id.
 * 
 * irqn:      8 bit width. The irq number of wuu input source.
 * 
 ...
 *            11b -- External input pin enabled with both edge change detection.
 */
