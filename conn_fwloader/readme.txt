1.Examples that support monolithic image download do not need the steps 2-5 to load fw:
	Wi-Fi examples: wifi_cli, wifi_wpa_supplicant, wifi_cert, wifi_webconfig, wifi_test_mode
