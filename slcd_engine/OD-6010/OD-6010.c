...
static const uint16_t *SLCD_Pos##x##_Upper_Letters[] = {                                            \
    SLCD_Pos##x##_Letter_A, NULL/*No B*/,           SLCD_Pos##x##_Letter_C, NULL/*No D*/,           \
    SLCD_Pos##x##_Letter_E, SLCD_Pos##x##_Letter_F, SLCD_Pos##x##_Letter_G, SLCD_Pos##x##_Letter_H, \
    SLCD_Pos##x##_Letter_I, NULL/*No J*/,           NULL/*No K*/,           SLCD_Pos##x##_Letter_L, \
    NULL/*No M*/,           SLCD_Pos##x##_Letter_N, SLCD_Pos##x##_Letter_O, NULL/*No P*/,           \
...
static const uint16_t *SLCD_Pos##x##_Lower_Letters[] = {                                            \
    NULL/*No a*/,           SLCD_Pos##x##_Letter_b, SLCD_Pos##x##_Letter_c, SLCD_Pos##x##_Letter_d, \
