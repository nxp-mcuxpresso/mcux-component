...
#if (SDK_DEBUGCONSOLE != DEBUGCONSOLE_DISABLE && SDK_DEBUGCONSOLE != DEBUGCONSOLE_RAM_CONSOLE) || defined(SDK_DEBUGCONSOLE_UART)

#include "fsl_component_serial_manager.h"

extern serial_handle_t g_serialHandle; /*!< serial manager handle */
#endif /* (SDK_DEBUGCONSOLE != DEBUGCONSOLE_DISABLE && SDK_DEBUGCONSOLE != DEBUGCONSOLE_RAM_CONSOLE) || defined(SDK_DEBUGCONSOLE_UART) */
