...
#define DC_FB_DCIF_MAX_LAYER                 ((uint32_t)DCIF_L_COUNT)
#define DC_FB_DCIF_DEFAULT_PIXEL_FORMAT      kVIDEO_PixelFormatRGB565
#define DC_FB_DCIF_DEFAULT_BYTE_PER_PIXEL    2U
...
typedef struct _dc_fb_dcif_config
{
    ...
    uint8_t domain;         /*!< Domain used for interrupt. */
    dcif_dpi_output_format_t output;         /*!< DPI output format. */
} dc_fb_dcif_config_t;
