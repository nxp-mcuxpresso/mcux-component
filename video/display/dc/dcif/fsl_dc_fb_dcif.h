...
#ifndef _FSL_DC_FB_DCIF_H_
#define _FSL_DC_FB_DCIF_H_
...
#define DC_FB_DCIF_MAX_LAYER                    ((uint32_t)3)
#define DC_FB_DCIF_DEFAULT_BUF_PER_LAYER        3U
#define DC_FB_DCIF_DEFAULT_PIXEL_FORMAT         kVIDEO_PixelFormatXRGB8888
#define DC_FB_DCIF_DEFAULT_PIXEL_FORMAT_DCIF    kDCIF_PixelFormatARGB8888
#define DC_FB_DCIF_DEFAULT_BYTE_PER_PIXEL       4U
#define DC_FB_DCIF_GLOBAL_ALPHA                 0xFFU

/*! @brief Data for DCIF display controller layer. */
typedef struct _dc_fb_dcif_layer
{
...
/*! @brief Data for DCIF display controller driver handle. */
typedef struct _dc_fb_dcif_handle
{
    DCIF_Type *dcif;                                   /*!< DCIF peripheral. */
    ...
    dc_fb_dcif_layer_t layers[DC_FB_DCIF_MAX_LAYER]; /*!< Information of the layer. */
} dc_fb_dcif_handle_t;

/*! @brief Configuration for DCIF display controller driver handle. */
typedef struct _dc_fb_dcif_config
{
    DCIF_Type *dcif;                /*!< DCIF peripheral. */
    ...
    uint32_t polarityFlags;         /*!< Control flags, OR'ed value of @ref _dcif_polarity_flags. */
    dcif_line_order_t lineOrder;    /*!< Line order. */
    uint8_t domain;                 /*!< Domain used to for interrupt. */
} dc_fb_dcif_config_t;

extern const dc_fb_ops_t g_dcFbOpsDcif;
